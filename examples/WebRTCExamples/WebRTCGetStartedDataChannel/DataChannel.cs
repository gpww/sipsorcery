...
namespace demo
{
    class DataChannel
    {
        ...
        private async static Task<RTCPeerConnection> CreatePeerConnection()
        {
            ...
            var pc = new RTCPeerConnection(config, 0, new PortRange(6000, 7000));
            ...
            //var dc = await pc.createDataChannel("oai-events", null);
        ...
        private static Microsoft.Extensions.Logging.ILogger AddConsoleLogger()
        {
            ...
            return factory.CreateLogger<DataChannel>();
        }
    }
}
